  ...
  return (
    <div className={styles.container}>
      <div className={styles.content}>
        ...
        <p>This Privacy Notice for Vilius Kurtkus trading as TrackVest (doing business as TrackVest) (&apos;we&apos;, &apos;us&apos;, or &apos;our&apos;), describes how and why we might access, collect, store, use, and/or share (&apos;process&apos;) your personal information when you use our services (&apos;Services&apos;), including when you:</p>
        <ul>
          <li>Download and use our mobile application (TrackVest), or any other application of ours that links to this Privacy Notice</li>
          <li>Use TrackVest. TrackVest is a mobile application for iOS and Android that helps users track and manage their alternative investment collections. The app provides portfolio valuation, market price estimates, performance tracking, and collection management tools. Users can add assets to their portfolio, view estimated market values, track gains/losses, and monitor their collection performance over time.</li>
          <li>Engage with us in other related ways, including any marketing or events</li>
        </ul>
        
        <p><strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:support@trackvest.app">support@trackvest.app</a>.</p>
        ...
        <section>
          ...
          <p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by visiting <a href="mailto:support@trackvest.app">support@trackvest.app</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
        </section>
        ...
        <section>
          ...
          <ol>
            ...
            <li><a href="#clausea">MARKET PRICE DISCLAIMERS AND LIMITATIONS</a></li>
        ...
        <section id="uslaws">
          ...
          <table style={{width: '100%', borderCollapse: 'collapse', marginBottom: '1rem'}}>
            <thead>
              <tr>
                <th style={{border: '1px solid #E5E7EB', padding: '0.75rem', textAlign: 'left', background: '#FAFAFA'}}>Category</th>
                <th style={{border: '1px solid #E5E7EB', padding: '0.75rem', textAlign: 'left', background: '#FAFAFA'}}>Examples</th>
                <th style={{border: '1px solid #E5E7EB', padding: '0.75rem', textAlign: 'center', background: '#FAFAFA'}}>Collected</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem'}}>A. Identifiers</td>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem'}}>Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem', textAlign: 'center'}}>YES</td>
              </tr>
              <tr>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem'}}>B. Personal information as defined in the California Customer Records statute</td>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem'}}>Name, contact information, education, employment, employment history, and financial information</td>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem', textAlign: 'center'}}>YES</td>
              </tr>
              <tr>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem'}}>G. Geolocation data</td>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem'}}>Device location</td>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem', textAlign: 'center'}}>YES</td>
              </tr>
              <tr>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem'}}>H. Audio, electronic, sensory, or similar information</td>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem'}}>Images and audio, video or call recordings created in connection with our business activities</td>
                <td style={{border: '1px solid #E5E7EB', padding: '0.75rem', textAlign: 'center'}}>YES</td>
              </tr>
            </tbody>
          </table>
          ...
          <p>To exercise these rights, you can contact us by visiting <a href="mailto:support@trackvest.app">support@trackvest.app</a>, by emailing us at <a href="mailto:support@trackvest.app">support@trackvest.app</a>, or by referring to the contact details at the bottom of this document.</p>
          ...
          <h3>Appeals</h3>
          <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:support@trackvest.app">support@trackvest.app</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
        ...
        <section id="clausea">
          <h2>12. MARKET PRICE DISCLAIMERS AND LIMITATIONS</h2>
          <p>The market price estimates and portfolio valuations provided by TrackVest are for informational purposes only and should not be construed as financial, investment, or professional advice. Price data is sourced from third-party providers and public market sources, and we do not guarantee the accuracy, completeness, or timeliness of any pricing information. Actual market values may vary significantly. Users should conduct their own research and consult with qualified professionals before making any financial decisions based on information provided by our services. We are not liable for any losses or damages arising from reliance on price estimates or valuations provided through our platform.</p>
        </section>
        ...
        <section id="contact">
          ...
          <p>If you have questions or comments about this notice, you may email us at <a href="mailto:support@trackvest.app">support@trackvest.app</a> or contact us by post at:</p>
          
          <p>
            Vilius Kubilius trading as TrackVest<br />
            4 Culmington road<br />
            London W13 9NR<br />
            United Kingdom
          </p>
        </section>
        ...
        <section id="request">
          ...
          <p>Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please visit: <a href="mailto:support@trackvest.app">support@trackvest.app</a>.</p>
        </section>
        ...
        <div style={{marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid #E5E7EB', textAlign: 'center', fontSize: '0.75rem', color: '#CBD5E1', opacity: 0.6}}>
          <p>This Privacy Policy was created using Termly&apos;s <a href="https://termly.io/products/privacy-policy-generator/" target="_blank" rel="noopener noreferrer" style={{color: '#94A3B8', textDecoration: 'none'}}>Privacy Policy Generator</a></p>
        </div>
